                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4
                    ...
                    <div className="col-span-2 md:row-span-2 flex flex-col justify-center p-5 sm:p-7 rounded-md bg-background-secondary border border-card-border">
                        ...
                        <p className="text-foreground-secondary text-sm leading-relaxed">
                            ...
                            · {a.desc3} <strong>32.1K</strong> {a.desc4}
                        </p>
                    </div>

                    {/* ── B: Main travel image (col-span-2) ── */}
                    <div className="col-span-2 rounded-md overflow-hidden shadow-xl">
                        <Image
                            src="https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?auto=format&fit=crop&w=800&q=80"
                            alt="Travel group enjoying trip"
                            width={800}
                            height={533}
                    ...
                    {/* ── C: Airplane image (col-span-1) ── */}
                    <div className="col-span-1 rounded-md overflow-hidden shadow-xl">
                        <Image
